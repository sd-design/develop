...
<head>
	<meta charset="utf-8">
	<title>Jquery Ajax webproject</title>
...
<div class="container">
	<div class="masthead">
        <h3 class="text-muted">Jquery ajax with validation of form</h3>
        <nav>
...
<div class="jumbotron" id="clean">
 ...
 <form action="form.php" method="post" accept-charset="utf-8" id="fileupload" enctype="multipart/form-data">
